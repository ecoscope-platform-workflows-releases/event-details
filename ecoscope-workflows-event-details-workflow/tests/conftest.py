...
IO_TASKS_IMPORTABLE_REFERENCES = [
    "ecoscope.platform.tasks.io.get_events_from_combined_params",
    "ecoscope.platform.tasks.io.get_fields_from_event_type_schema",
    "ecoscope.platform.tasks.io.get_choices_from_v2_event_type",
